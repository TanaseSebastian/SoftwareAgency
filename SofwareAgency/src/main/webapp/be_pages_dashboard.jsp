...
<html lang="en" class="no-focus">
    <head>
        ...
        <!-- Page JS Plugins CSS -->
        <link rel="stylesheet" href="backend/js/plugins/slick/slick.css">
        <link rel="stylesheet" href="backend/js/plugins/slick/slick-theme.css">
    ...
    <body>
                            ...
                            <ul class="nav-users push">
                                <li>
                                    <a href="be_pages_generic_profile.html">
                                        <img class="img-avatar" src="backend/media/avatars/avatar2.jpg" alt="">
                                ...
                                <li>
                                    <a href="be_pages_generic_profile.html">
                                        <img class="img-avatar" src="backend/media/avatars/avatar11.jpg" alt="">
        ...
        <div class="modal fade" id="modal-onboarding" tabindex="-1" role="dialog" aria-labelledby="modal-onboarding" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-popout" role="document">
                <div class="modal-content rounded">
                    <div class="block block-rounded block-transparent mb-0 bg-pattern" style="background-image: url('backend/media/various/bg-pattern-inverse.png');">
        ...
        <!-- Page JS Plugins -->
        <script src="backend/js/plugins/chartjs/Chart.bundle.min.js"></script>
        <script src="backend/js/plugins/slick/slick.min.js"></script>

        <!-- Page JS Code -->
        <script src="backend/js/pages/be_pages_dashboard.min.js"></script>
    </body>
</html>