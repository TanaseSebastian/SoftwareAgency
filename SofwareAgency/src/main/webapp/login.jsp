    ...
    <body>
        ...
        <div id="page-container" class="main-content-boxed">
            ...
            <main id="main-container">
                ...
                <!-- Page Content -->
                <div class="bg-image" style="background-image: url('backend/media/photos/photo34@2x.jpg');">
                    <div class="row mx-0 bg-black-op">
                        ...
                        <div class="hero-static col-md-6 col-xl-4 d-flex align-items-center bg-white invisible" data-toggle="appear" data-class="animated fadeInRight">
                            <div class="content content-full">
                                ...
                                <form class="js-validation-signin px-30" action="gestlogin?cmd=login" method="post">
        ...
        <!-- Page JS Code -->
        <script src="backend/js/pages/op_auth_signin.min.js"></script>
    </body>
</html>