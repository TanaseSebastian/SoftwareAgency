                    ...
                    <div class="block pull-r-l">
                        ...
                        <div class="block-content">
                            <ul class="nav-users push">
                                ...
                                <li>
                                    <a href="be_pages_generic_profile.html">
                                        <img class="img-avatar" src="backend/media/avatars/avatar10.jpg" alt="">
                            ...
                            <li class="open">
                                ...
                                <ul>
                                    ...
                                    <li class="open">
                                        ...
                                        <ul>
                                            <li>
                                                <a class="active" href="be_pages_real_estate_dashboard.html">Dashboard</a>
                                            </li>
                                            <li>
                ...
                <div class="content">
                    <div class="my-50 text-center">
                        ...
                        <h3 class="h5 text-muted mb-0">
                            You currently have 6 properties! <a href="be_pages_real_estate_listing_new.html">Add a new one</a>.
                        </h3>
                    </div>
                    <div class="row">
                            ...
                            <div class="block block-rounded">
                                <div class="block-content p-0 overflow-hidden">
                                    <a class="img-link" href="be_pages_real_estate_listing.html">
                                        <img class="img-fluid rounded-top" src="backend/media/photos/photo35.jpg" alt="">
                                    </a>
                                </div>
                                ...
                                <div class="block-content block-content-full">
                                    <div class="row">
                                        <div class="col-6">
                                            <a class="btn btn-sm btn-hero btn-noborder btn-secondary btn-block" href="be_pages_real_estate_listing.html">
                                                Details
                                            </a>
                                        </div>
                                        <div class="col-6">
                        ...
                        <div class="col-md-6 col-xl-4 invisible" data-toggle="appear">
                            ...
                            <div class="block block-rounded">
                                <div class="block-content p-0 overflow-hidden">
                                    <a class="img-link" href="be_pages_real_estate_listing.html">
                                        <img class="img-fluid rounded-top" src="backend/media/photos/photo36.jpg" alt="">
                                    </a>
                                </div>
                                <div class="block-content border-bottom">
                        ...
                        <div class="col-md-6 col-xl-4 invisible" data-toggle="appear">
                            ...
                            <div class="block block-rounded">
                                <div class="block-content p-0 overflow-hidden">
                                    <a class="img-link" href="be_pages_real_estate_listing.html">
                                        <img class="img-fluid rounded-top" src="backend/media/photos/photo37.jpg" alt="">
                                    </a>
                                </div>
                                <div class="block-content border-bottom">
                        ...
                        <div class="col-md-6 col-xl-4 invisible" data-toggle="appear">
                            ...
                            <div class="block block-rounded">
                                <div class="block-content p-0 overflow-hidden">
                                    <a class="img-link" href="be_pages_real_estate_listing.html">
                                        <img class="img-fluid rounded-top" src="backend/media/photos/photo38.jpg" alt="">
                                    </a>
                                </div>
                                <div class="block-content border-bottom">
                        ...
                        <div class="col-md-6 col-xl-4 invisible" data-toggle="appear">
                            ...
                            <div class="block block-rounded">
                                <div class="block-content p-0 overflow-hidden">
                                    <a class="img-link" href="be_pages_real_estate_listing.html">
                                        <img class="img-fluid rounded-top" src="backend/media/photos/photo40.jpg" alt="">
                                    </a>
                                </div>
                                <div class="block-content border-bottom">
                        ...
                        <div class="col-md-6 col-xl-4 invisible" data-toggle="appear">
                            ...
                            <div class="block block-rounded">
                                <div class="block-content p-0 overflow-hidden">
                                    <a class="img-link" href="be_pages_real_estate_listing.html">
                                        <img class="img-fluid rounded-top" src="backend/media/photos/photo39.jpg" alt="">
                                    </a>
                                </div>
                                <div class="block-content border-bottom">
