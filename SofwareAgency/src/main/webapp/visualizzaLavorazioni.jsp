     ...
     <div class="bg-image" style="background-image: url('assets/media/photos/photo26@2x.jpg');">
                    <div class="bg-black-op-75">
                        <div class="content content-top content-full text-center">
                            <div class="py-20">
                                <h1 class="h2 font-w700 text-white mb-10"> <i class="fa fa-laptop text-muted mr-5"></i> Software Management</h1>
                                <h2 class="h4 font-w400 text-white-op mb-0"> Hai attualmente 6 Software! <a href="nuovoSoftware.jsp">Aggiungine uno</a>.</h2>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                            ...
                            <div class="block block-rounded">
                                <div class="block-content p-0 overflow-hidden">
                                    <a class="img-link" href="be_pages_real_estate_listing.html">
                                        <img class="img-fluid rounded-top" src="assets/media/photos/photo35.jpg" alt="">
                                    </a>
                                </div>
                        ...
                        <div class="col-md-6 col-xl-4 invisible" data-toggle="appear">
                            ...
                            <div class="block block-rounded">
                                <div class="block-content p-0 overflow-hidden">
                                    <a class="img-link" href="be_pages_real_estate_listing.html">
                                        <img class="img-fluid rounded-top" src="assets/media/photos/photo36.jpg" alt="">
                                    </a>
                                </div>
                                <div class="block-content border-bottom">
                        ...
                        <div class="col-md-6 col-xl-4 invisible" data-toggle="appear">
                            ...
                            <div class="block block-rounded">
                                <div class="block-content p-0 overflow-hidden">
                                    <a class="img-link" href="be_pages_real_estate_listing.html">
                                        <img class="img-fluid rounded-top" src="assets/media/photos/photo37.jpg" alt="">
                                    </a>
                                </div>
                                <div class="block-content border-bottom">
                        ...
                        <div class="col-md-6 col-xl-4 invisible" data-toggle="appear">
                            ...
                            <div class="block block-rounded">
                                <div class="block-content p-0 overflow-hidden">
                                    <a class="img-link" href="be_pages_real_estate_listing.html">
                                        <img class="img-fluid rounded-top" src="assets/media/photos/photo38.jpg" alt="">
                                    </a>
                                </div>
                                <div class="block-content border-bottom">
                        ...
                        <div class="col-md-6 col-xl-4 invisible" data-toggle="appear">
                            ...
                            <div class="block block-rounded">
                                <div class="block-content p-0 overflow-hidden">
                                    <a class="img-link" href="be_pages_real_estate_listing.html">
                                        <img class="img-fluid rounded-top" src="assets/media/photos/photo40.jpg" alt="">
                                    </a>
                                </div>
                                <div class="block-content border-bottom">
                        ...
                        <div class="col-md-6 col-xl-4 invisible" data-toggle="appear">
                            ...
                            <div class="block block-rounded">
                                <div class="block-content p-0 overflow-hidden">
                                    <a class="img-link" href="be_pages_real_estate_listing.html">
                                        <img class="img-fluid rounded-top" src="assets/media/photos/photo39.jpg" alt="">
                                    </a>
                                </div>
                                <div class="block-content border-bottom">
