...
<html lang="en" class="no-focus">
    <head>
        ...
        <!-- Page JS Plugins CSS -->
        <link rel="stylesheet" href="backend/js/plugins/magnific-popup/magnific-popup.css">
    ...
    <body>
                            ...
                            <ul class="nav-users push">
                                <li>
                                    <a href="be_pages_generic_profile.html">
                                        <img class="img-avatar" src="backend/media/avatars/avatar1.jpg" alt="">
                                ...
                                <li>
                                    <a href="be_pages_generic_profile.html">
                                        <img class="img-avatar" src="backend/media/avatars/avatar13.jpg" alt="">
                                ...
                                <li>
                                    <a href="be_pages_generic_profile.html">
                                        <img class="img-avatar" src="backend/media/avatars/avatar7.jpg" alt="">
                                ...
                                <ul>
                                    ...
                                    <li class="open">
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <a class="active" href="be_pages_real_estate_listing.html">Listing</a>
                                            </li>
                                            <li>
            ...
            <main id="main-container">
                ...
                <div class="content">
                    ...
                    <div class="block block-rounded block-fx-shadow">
                        <div class="block-content p-0 bg-image" style="background-image: url('backend/media/photos/photo35@2x.jpg');">
                            ...
                            <div class="row">
                                <div class="col-md-6 order-md-2 py-20">
                                    <div class="row gutters-tiny js-gallery img-fluid-100">
                                        <div class="col-6">
                                            <a class="img-link img-link-simple img-thumb img-lightbox" href="backend/media/photos/photo35@2x.jpg">
                                                <img class="img-fluid" src="backend/media/photos/photo35.jpg" alt="">
                                            </a>
                                        </div>
                                        <div class="col-6">
                                            <a class="img-link img-link-simple img-thumb img-lightbox" href="backend/media/photos/photo41@2x.jpg">
                                                <img class="img-fluid" src="backend/media/photos/photo41.jpg" alt="">
                                            </a>
                                        </div>
                                        <div class="col-6">
                                            <a class="img-link img-link-simple img-thumb img-lightbox" href="backend/media/photos/photo42@2x.jpg">
                                                <img class="img-fluid" src="backend/media/photos/photo42.jpg" alt="">
                                            </a>
                                        </div>
                                        <div class="col-6">
                                            <a class="img-link img-link-simple img-thumb img-lightbox" href="backend/media/photos/photo43@2x.jpg">
                                                <img class="img-fluid" src="backend/media/photos/photo43.jpg" alt="">
                                            </a>
                                        </div>
                                    </div>
                                </div>
        ...
        <!-- Page JS Plugins -->
        <script src="backend/js/plugins/magnific-popup/jquery.magnific-popup.min.js"></script>
