			...
			<div class="content content-top content-full text-center">
				<div class="py-20">
					...
					<h2 class="h4 font-w400 text-white-op mb-0">in questa sezione
						vi sono tutte le informazioni riguardanti questo dipendente e le informazioni riguardanti la lavorazione.</h2>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="content py-5 text-center">
			<nav class="breadcrumb bg-body-light mb-0">
				<a class="breadcrumb-item" href="dashboard.jsp">Dashboard</a> <span
					...
					class="breadcrumb-item active">Dettagli Personale</span>
			</nav>
		</div>
	</div>
	<!-- END Breadcrumb -->
				...
				<table class="table table-bordered table-striped table-vcenterd"
					...
					<thead>
						<tr>
							...
							<th>Descrizione lavoro da svolgere in questa lavorazione</th>
						</tr>
					</thead>
					<tbody>
						<tr>
